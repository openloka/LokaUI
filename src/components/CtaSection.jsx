    ...
    >
      ...
      >
        ...
        <div className="flex gap-3 justify-center flex-wrap relative">
          <a href="/docs/getting-started" className="px-7 py-3 rounded-xl bg-accent text-accent-text text-sm font-semibold hover:bg-accent-hover active:scale-[0.96] transition-all">
            Get started free
          </a>
          <a href="https://github.com/openloka/LokaUI" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 px-7 py-3 rounded-xl bg-transparent border border-border text-text-primary text-sm font-semibold hover:border-border-hover hover:bg-bg-elevated active:scale-[0.96] transition-all">
